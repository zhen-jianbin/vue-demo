<template>
  <div>
    <div class="up card c606266">
      <span style="padding-top: 5px" class="mr10">竞赛创建</span>
    ...
    <!--新建/编辑的弹窗-->
    <el-dialog v-model="visible" v-if="visible" width="30%" title="竞赛创建">
...
import CompetitionManageDialog from "./competitionCreateDialog.vue";
export default {
  mounted() {
    //初始化设定列表每列显示的属性和名称
