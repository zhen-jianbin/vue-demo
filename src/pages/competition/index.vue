<template>
  <div>
    <div class="up card c606266">
      <span style="padding-top: 5px" class="mr10">竞赛报名</span>
    ...
    <!--新建/编辑的弹窗-->
    <el-dialog v-model="visible" v-if="visible" width="30%" title="竞赛报名">
      <Competitions
        :id="choiceId"
        :schoolId="schoolId"
        @doCancel="doCancel"
...
<script>
import Competitions from "./competitionDialog.vue";
